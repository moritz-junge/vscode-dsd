...
async function createServer(
    ...
    const clientOptions: LanguageClientOptions = {
        // Register the server for dsd documents
        documentSelector: isVirtualWorkspace()
            ? [{ language: 'dsd' }]
            : [
                  { scheme: 'file', language: 'dsd' },
                  { scheme: 'untitled', language: 'dsd' },
                  { scheme: 'vscode-notebook', language: 'dsd' },
                  { scheme: 'vscode-notebook-cell', language: 'dsd' },
              ],
